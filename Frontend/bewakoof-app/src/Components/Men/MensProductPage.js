    ...
    return (
        ...
        <Box   pr={"40px"} pl={"40px"} >
            <Box>
                ...
                <Text fontWeight='bold' fontSize={['xl', '2xl', '2xl', '2xl']} textAlign={{base:"center", md:"center", lg:"left"}} mt={35} letterSpacing='wide'>Men Clothing (50)</Text>
                ...
                <Flex direction={{base:"column", lg:"row", md:"row"}} mt={10} mb={6} gap={2}>
                    ...
                    <Box width={"30%"} p={5} display={{ sm:"block",base:"none"}} mt={-6}>
                        <Flex gap={"50%"}  height={"20px"} flexDirection={"row"} >
                        ...
                        <Accordion defaultIndex={[0]} allowMultiple>
                            ...
                            <AccordionItem>
                                ...
                                <AccordionPanel pb={1} fontSize={"13px"} ml="22px" textAlign="left"  color={"#6C6C6C"}> T-Shirt </AccordionPanel>
                                <AccordionPanel pb={1} fontSize={"13px"} ml="22px" textAlign="left"  color={"#6C6C6C"}> Shirt </AccordionPanel>
                                <AccordionPanel pb={1} fontSize={"13px"} ml="22px" textAlign="left" color={"#6C6C6C"}> Sweatshirt </AccordionPanel>
                                <AccordionPanel pb={1} fontSize={"13px"} ml="22px" textAlign="left" color={"#6C6C6C"}> Boxers </AccordionPanel>
                                <AccordionPanel pb={1} fontSize={"13px"} ml="22px" textAlign="left" color={"#6C6C6C"}> Brief </AccordionPanel>
                                <AccordionPanel pb={1} fontSize={"13px"} ml="22px" textAlign="left" color={"#6C6C6C"}> Hoodies </AccordionPanel>
                                <AccordionPanel pb={1} fontSize={"13px"} ml="22px" textAlign="left" color={"#6C6C6C"}> Joggers </AccordionPanel>
                                <AccordionPanel pb={1} fontSize={"13px"} ml="22px" textAlign="left" color={"#6C6C6C"}> Shorts </AccordionPanel>
                                <AccordionPanel pb={1} fontSize={"13px"} ml="22px" textAlign="left" color={"#6C6C6C"}> Jacket </AccordionPanel>
                                <AccordionPanel pb={1} fontSize={"13px"} ml="22px" textAlign="left" color={"#6C6C6C"}> Kurta </AccordionPanel>
                                <AccordionPanel pb={1} fontSize={"13px"} ml="22px" textAlign="left" color={"#6C6C6C"}> Vest </AccordionPanel>
                                <AccordionPanel pb={1} fontSize={"13px"} ml="22px" textAlign="left" color={"#6C6C6C"}> Jeans </AccordionPanel>
                                <AccordionPanel pb={1} fontSize={"13px"} ml="22px" textAlign="left" color={"#6C6C6C"}> Trunk </AccordionPanel>
                                <AccordionPanel pb={1} fontSize={"13px"} ml="22px" textAlign="left" color={"#6C6C6C"}> Pyjama </AccordionPanel>
                                <AccordionPanel pb={1} fontSize={"13px"} ml="22px" textAlign="left" color={"#6C6C6C"}> Track Pant </AccordionPanel>
                                <AccordionPanel pb={1} fontSize={"13px"} ml="22px" textAlign="left" color={"#6C6C6C"}> Co-Ordinates </AccordionPanel>
                                <AccordionPanel pb={1} fontSize={"13px"} ml="22px" textAlign="left" color={"#6C6C6C"}> Chino </AccordionPanel>
                                <AccordionPanel pb={1} fontSize={"13px"} ml="22px" textAlign="left" color={"#6C6C6C"}> Sweater </AccordionPanel>
                                <AccordionPanel pb={1} fontSize={"13px"} ml="22px" textAlign="left" color={"#6C6C6C"}> Kurta Set </AccordionPanel>
                                <AccordionPanel pb={1} fontSize={"13px"} ml="22px" textAlign="left" color={"#6C6C6C"}> Shirt & Shoes Set </AccordionPanel>
                                <AccordionPanel pb={1} fontSize={"13px"} ml="22px" textAlign="left" color={"#6C6C6C"}> Trousers </AccordionPanel>
                                <AccordionPanel pb={1} fontSize={"13px"} ml="22px" textAlign="left" color={"#6C6C6C"}> Casual Pants </AccordionPanel>
                                <AccordionPanel pb={1} fontSize={"13px"} ml="22px" textAlign="left" color={"#6C6C6C"}> Nightsuits </AccordionPanel>
                                <AccordionPanel pb={1} fontSize={"13px"} ml="22px" textAlign="left" color={"#6C6C6C"}> Sweatshirt & Jogger Set </AccordionPanel>
                                <AccordionPanel pb={1} fontSize={"13px"} ml="22px" textAlign="left" color={"#6C6C6C"}> T-Shirt & Pyjama Set </AccordionPanel>
                                <AccordionPanel pb={1} fontSize={"13px"} ml="22px" textAlign="left" color={"#6C6C6C"}> Tracksuit </AccordionPanel>
                                <AccordionPanel pb={1} fontSize={"13px"} ml="22px" textAlign="left" color={"#6C6C6C"}> Cloth Mask </AccordionPanel>
                                <AccordionPanel pb={1} fontSize={"13px"} ml="22px" textAlign="left" color={"#6C6C6C"}> Lounge Pants </AccordionPanel>
                                <AccordionPanel pb={1} fontSize={"13px"} ml="22px" textAlign="left" color={"#6C6C6C"}> HipstersTrunks </AccordionPanel>
                                <AccordionPanel pb={1} fontSize={"13px"} ml="22px" textAlign="left" color={"#6C6C6C"}> Lounge Shorts </AccordionPanel>
                                <AccordionPanel pb={1} fontSize={"13px"} ml="22px" textAlign="left" color={"#6C6C6C"}> Protective Outdooor Mask </AccordionPanel>
                                <AccordionPanel pb={1} fontSize={"13px"} ml="22px" textAlign="left" color={"#6C6C6C"}> T-Shirt & Shorts Set </AccordionPanel>
                                <AccordionPanel pb={1} fontSize={"13px"} ml="22px" textAlign="left" color={"#6C6C6C"}> Denim </AccordionPanel>
                                <AccordionPanel pb={1} fontSize={"13px"} ml="22px" textAlign="left" color={"#6C6C6C"}> Nehru Jacket </AccordionPanel>
                                <AccordionPanel pb={1} fontSize={"13px"} ml="22px" textAlign="left" color={"#6C6C6C"}> Blazer </AccordionPanel>
                                <AccordionPanel pb={1} fontSize={"13px"} ml="22px" textAlign="left" color={"#6C6C6C"}> Hoodie And Shorts Set </AccordionPanel>
                                <AccordionPanel pb={1} fontSize={"13px"} ml="22px" textAlign="left" color={"#6C6C6C"}> Pant </AccordionPanel>
                                <AccordionPanel pb={1} fontSize={"13px"} ml="22px" textAlign="left" color={"#6C6C6C"}> Jumpsuit </AccordionPanel>
                                <AccordionPanel pb={1} fontSize={"13px"} ml="22px" textAlign="left" color={"#6C6C6C"}> T-Shirt & Jogger Set </AccordionPanel>
                            </AccordionItem>
                    ...
                    {/* right box */}
                    <Box width={"70%"}>
                        <SimpleGrid columns={[1, 2, 2, 3]} spacing={6} height={"670px"} direction={{base:"column", lg:"row"}} overflow={"scroll"} >
                                {data?.map((e)=>{
                                    return (
                                        <Box className="mapBox" p={1}>
                                            <Image src={e.image} h={"270px"}></Image>
                                            <Text fontWeight={"semibold"} color={"#4F5362"} fontSize={"13px"} letterSpacing={"wide"}>Bewakoof</Text>
                                            <Text fontWeight={"normal"} color={"#949494"} fontSize={"11px"} letterSpacing={"wide"}>Men's White The Ryuk Graphic Printed T-Shirt</Text>
                                            <Flex gap={1.5} mb={1}>
                                                <Text fontWeight={"bold"} color={"black"} fontSize={"16px"} letterSpacing={"wide"}>₹349</Text>
                                                <Text fontWeight={"normal"} color={"#949494"} fontSize={"13px"} textDecoration={"line-through"} mt={1}>₹999</Text>
                                            </Flex>
                                            <Text fontWeight={"bold"} color={"#2F2F2F"} fontSize={"11px"} ml={2}>₹319 for TriBe Members</Text>
                                        </Box>
                                    )
                                })}
                        </SimpleGrid>
