...
import * as data from './navWomensData'
            ...
            <Box display={"flex"}  justifyContent={"space-between"} >
                ...
                <Box  >
                    ...
                    <Heading fontFamily={"Montserrat"} fontSize={"14px"} mb={"9px"} fontWeight={500} >
                        ...
                        {
                        data.Sports_Activewear.map((e,i) => {
                            return <Text key={e+i}
                                        _hover={{cursor:"pointer",textDecoration:"underline"}}
                                        mb={"6px"}  
                                    >
...
{/* third */}
            ...
            <Box display={"flex"}  justifyContent={"space-between"} >
                <Box  >
                    ...
                    {
                        data.Innerwear_Loungewear.map((e,i) => {
                            return <Text  key={e+i}
                                        _hover={{cursor:"pointer",textDecoration:"underline"}}
                                        mb={"6px"}  
                                    >
