...
<Tabs variant='unstyled' marginTop={"10px"}>
  ...
  <TabPanels>
    <TabPanel>
      <Text fontSize={"13px"} color={"RGBA(0, 0, 0, 0.48)"}>Garment:Chest (in Inch):38.0 | Front Length (in Inch):27.25 | Sleeve Length (in Inch):8.0</Text>
    </TabPanel>
    <TabPanel>
      <Text fontSize={"13px"} color={"RGBA(0, 0, 0, 0.48)"}>Garment:Chest (in Inch):40.0 | Front Length (in Inch):28.0 | Sleeve Length (in Inch):8.25</Text>
    </TabPanel>
    <TabPanel>
      <Text fontSize={"13px"} color={"RGBA(0, 0, 0, 0.48)"}>Garment:Chest (in Inch):42.0 | Front Length (in Inch):28.75 | Sleeve Length (in Inch):8.5</Text>
    </TabPanel>
    <TabPanel>
      <Text fontSize={"13px"} color={"RGBA(0, 0, 0, 0.48)"}>Garment:Chest (in Inch):44.0 | Front Length (in Inch):29.5 | Sleeve Length (in Inch):8.75</Text>
    </TabPanel>
    <TabPanel>
      <Text fontSize={"13px"} color={"RGBA(0, 0, 0, 0.48)"}>Garment:Chest (in Inch):46.0 | Front Length (in Inch):30.0 | Sleeve Length (in Inch):9.0</Text>
    </TabPanel>
  </TabPanels>
</Tabs>
    )
