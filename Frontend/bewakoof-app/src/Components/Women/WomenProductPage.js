        ...
        <Box   pr={"40px"} pl={"40px"} >
            <Box>
                ...
                <Flex direction={{base:"column", lg:"row", md:"row"}} mt={10} mb={6} gap={2}>
                    ...
                    {/* right box */}
                    <Box width={"70%"}>
                        <SimpleGrid columns={[1, 2, 2, 3]} spacing={1} height={"670px"} direction={{base:"column", lg:"row"}} overflow={"scroll"}>
                                {data?.map((e)=>{
                                    return (
                                        <Box className="mapBox" p={1}>
                                            <Image src={e.image} h={"270px"}></Image>
                                            <Text fontWeight={"medium"} color={"#4F5362"} fontSize={"13px"} letterSpacing={"wide"}>Bewakoof</Text>
